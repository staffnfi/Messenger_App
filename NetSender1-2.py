#Version 1.2: Improved window focus. set up window that accepts a display name. Display name concatenated with chat
#message. Code refactoring - more in keeping with MVC philosophy; app_data class acts as model; holds config settings for
# networking and app functionality.
